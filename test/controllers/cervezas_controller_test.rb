...
class CervezasControllerTest < ActionController::TestCase
  ...
  test "should create cerveza" do
    assert_difference('Cerveza.count') do
      post :create, cerveza: { descripcion: @cerveza.descripcion, marca: @cerveza.marca, nombre: @cerveza.nombre, stock: @cerveza.stock }
    end
  ...
  test "should update cerveza" do
    patch :update, id: @cerveza, cerveza: { descripcion: @cerveza.descripcion, marca: @cerveza.marca, nombre: @cerveza.nombre, stock: @cerveza.stock }
    assert_redirected_to cerveza_path(assigns(:cerveza))
  end
